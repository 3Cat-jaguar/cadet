...
void	dda_algorithm(t_ra *ray, t_game *info)
{
	if (ray->dir_x < 0)
	{
		ray->step_x = -1;
...
void	sol_fisheye(t_ra *ray, t_game *info)
{
	if (ray->side == 0)
	{
		ray->perp_wall_dist =
...
void	vertical_line(t_ra *ray, t_cub *map)
{
